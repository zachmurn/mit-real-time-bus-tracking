...
mapboxgl.accessToken = 'pk.eyJ1IjoidGhvbWFzbW9ydG9uMTc3NiIsImEiOiJja3BybWdzcmswNno2Mm9wbWRqc3VhaHIwIn0.8Ax2XiAseESQCZu7reVcBg';
...
let counter = 0;
function move() {
  // Moves the marker on the map every 1000ms. Uses the function marker.setLngLat() to update the marker coordinates
